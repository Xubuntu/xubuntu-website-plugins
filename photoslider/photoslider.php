...
function PhotosliderScripts( ) {
	...
	wp_register_script( 'photoslider', plugins_url( 'photoslider' ) . '/slider.js', array ( 'jquery' ), '1.4' );
	wp_enqueue_script( 'photoslider' );

	wp_register_style( 'photoslider-defaults', plugins_url( 'photoslider' ) . '/defaults.css' );
